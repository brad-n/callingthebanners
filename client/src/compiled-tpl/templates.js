angular.module('templates-main', ['js/contact/contact.html', 'js/faq/faq.html', 'js/groups/group_list.html', 'js/groups/modals/group_adduser.modal.html', 'js/groups/modals/group_create.modal.html', 'js/header/header.tpl.html', 'js/login/login.html', 'js/main/main.html', 'js/player/faction_winloss.html', 'js/player/player_details.html', 'js/player/player_nemesis.html', 'js/player/player_rival.html', 'js/player/player_rounds.html', 'js/player/player_tournaments.html', 'js/player/top_players.html', 'js/search/search_form.tpl.html', 'js/search/search.html', 'js/stats/faction_matchups.html', 'js/stats/faction_wins_linechart.html', 'js/stats/match_details.html', 'js/stats/played_factions_linechart.html', 'js/stats/stats.html', 'js/whatsnew/whatsnew.html']);
...
angular.module("js/groups/group_list.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("js/groups/group_list.html",
    "<div class=\"col-sm-10 col-sm-offset-1 card bounceIn\">\n" +
    "	<div class=\"view\">\n" +
    ...
    "				You do not currently belong to any groups.  Would you like to <a href=\"javascript:void(0);\" ng-click=\"show();\">Create</a> one?\n" +
    "			</div>\n" +
    "			\n" +
    "			\n" +
...
angular.module("js/groups/modals/group_adduser.modal.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("js/groups/modals/group_adduser.modal.html",
...
angular.module("js/groups/modals/group_create.modal.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("js/groups/modals/group_create.modal.html",
    "<div class=\"modal\" id=\"basicExample\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n" +
    "    <div class=\"modal-dialog bounceIn\" role=\"document\">\n" +
    "        <!--Content-->\n" +
    "        <div class=\"modal-content\">\n" +
    "            <!--Header-->\n" +
    "            <div class=\"modal-header\">\n" +
